...
> Главная страница с описанием сервиса, точностью модели и шагами работы.

### 2. Регистрация
![Регистрация](screenshots/2.png)
> Новый пользователь регистрируется и автоматически получает 100 кредитов.

### 3. Форма предсказания
![Форма](screenshots/6.png)
> Заполнение анкеты заёмщика — 13 полей, все на русском языке.

### 4. Результат — Одобрено
![Одобрено](screenshots/7.png)
> Асинхронный результат от ML-модели: решение, вероятность и списание кредитов.

### 5. История предсказаний
![История](screenshots/8.png)
> Все запросы пользователя с решениями, вероятностями и датами.

### 6. Биллинг
![Биллинг](screenshots/9.png)
> Баланс, история транзакций, пополнение и активация промокода.
